...
PlayerFallAction::PlayerFallAction(PlayerData *playerData)
{
...
PlayerFallAction::~PlayerFallAction()
{
}

void PlayerFallAction::Update(float dt)
{
...
void PlayerFallAction::HandleKeyboard(std::map<int, bool> keys)
{
    if (keys[VK_RIGHT])
    {
...
PlayerState::StateName PlayerFallAction::GetState()
{
    return PlayerState::FallAction;
}


void PlayerFallAction::OnCollision(Entity *impactor, Entity::SideCollisions side, Entity::CollisionReturn data)
{
